...
function UrgentCard({
  icon, title, score, verdict, issues,
}: {
      ...
      <main className="min-h-screen bg-[#080c14] bg-grid">
            ...
            <div className="flex items-center gap-3">
              ...
              {reportId && (
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs text-slate-400 hover:text-blue-400 bg-slate-800 hover:bg-slate-700 px-3 py-1.5 rounded-lg transition-all"
                >
                  {copied ? "✓ 복사됨" : "🔗 링크 복사"}
                </button>
              )}
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-display font-semibold text-slate-300">CRODiagnostic</span>
              </div>
            </div>
          </div>
        </nav>
        ...
        <div className="max-w-4xl mx-auto px-6 py-10 space-y-6">
          ...
          <div className="dash-card p-6">
            <h2 className="text-xs font-mono text-slate-500 uppercase tracking-widest mb-5">📊 카테고리별 점수</h2>
          ...
          {/* 긴급 진단 */}
          <div>
            <h2 className="text-xs font-mono text-slate-500 uppercase tracking-widest mb-3">🚨 긴급 진단 — 3대 매출 킬러</h2>
          ...
          {/* AI 처방전 */}
          <div>
            <h2 className="text-xs font-mono text-slate-500 uppercase tracking-widest mb-3">💊 AI 처방전 — 즉시 수정 리스트</h2>
          ...
          <div className="dash-card p-6 sm:p-8 border-blue-500/20 text-center">
            {pdfSuccess ? (
              <div className="space-y-2">
                ...
                <p className="text-slate-400 text-sm">입력하신 이메일로 상세 PDF 리포트를 보내드리겠습니다.</p>
              </div>
            ) : (
              <>
                <div className="text-3xl mb-3">📄</div>
                <h3 className="font-display font-bold text-white text-xl mb-2">더 자세한 처방이 필요하신가요?</h3>
                ...
                <p className="text-xs text-slate-600 mt-3">스팸 없음 · 언제든 수신 거부 가능</p>
              </>
            )}
          </div>

          <p className="text-center text-xs text-slate-700 pb-4">
            본 리포트는 GPT-4o AI 자동 분석 결과로, 전문가 컨설팅을 대체하지 않습니다. © 2024 CRODiagnostic
          </p>
        </div>
      </main>
    </>
